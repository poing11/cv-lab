...
class ObjectDetectionModel:
    ...
    def _load_model(self, model_name):
        ...
        # Try local YOLOv5 repo
            ...
            print("✅ Loaded YOLOv5 model from local repo")
        except Exception as e:
            print(f"⚠️ Error loading model locally: {e}")
            print("➡️ Falling back to Torch Hub (online)")
        # Fallback to Torch Hub (always works if internet available)
            model = torch.hub.load(
                'ultralytics/yolov5',
                model_name,
                pretrained=True
...
def demo_with_sample_images():
    ...
    sample_images = [
        r"C:\Users\Avisha\Downloads\car.jpg",
        r"C:\Users\Avisha\Downloads\dog.jpeg",
    ]
